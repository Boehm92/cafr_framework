...
class MachiningFeature:
    def __init__(self, base_part, machining_feature, machining_feature_limit):
        self.base_part = base_part
        self.machining_feature = machining_feature
        self.machining_feature_limit = machining_feature_limit
    ...
    def o_ring(self):
        ...
        _outside_ring_radius = np.random.uniform(1, (4.5 * self.machining_feature_limit))
        ...
        updated_model = mdc.difference(self.base_part, o_ring)
    ...
    def trough_hole(self):
        ...
        _radius = np.random.uniform(0.5, (4.5 * self.machining_feature_limit))
        ...
        updated_model = mdc.difference(self.base_part, cylinder)
        updated_model.mergeclose()
        updated_model = mdc.segmentation(updated_model)
    ...
    def triangular_passage(self):
        ...
        L = np.random.uniform(1, (9 * self.machining_feature_limit))
        D = 10.4
        ...
        updated_model = mdc.difference(self.base_part, triangular_passage)
        updated_model.mergeclose()
        updated_model = mdc.segmentation(updated_model)
    ...
    def rectangular_passage(self):
        ...
        L = np.random.uniform(1, (9 * self.machining_feature_limit))
        W = np.random.uniform(1, (9 * self.machining_feature_limit))
        Depth = 10.4
        ...
        updated_model = mdc.difference(self.base_part, _rectangular_passage)
        updated_model.mergeclose()
        updated_model = mdc.segmentation(updated_model)
    ...
    def circular_trough_slot(self):
        ...
        R = np.random.uniform(1, (4.5 * self.machining_feature_limit))
        X = np.random.uniform(R + 0.5, 9.5 - R)

        _circular_trough_slot = mdc.cylinder(mdc.vec3(X, -0.2, 10), mdc.vec3(X, 10.2, 10), R)

        updated_model = mdc.difference(self.base_part, _circular_trough_slot)
        updated_model.mergeclose()
        updated_model = mdc.segmentation(updated_model)
    ...
    def triangular_trough_slot(self):
        ...
        W = np.random.uniform(1, (9 * self.machining_feature_limit))
        D = np.random.uniform(1, (9 * self.machining_feature_limit))
        X = np.random.uniform(0.5, 9.5 - W)
        ...
        updated_model = mdc.difference(self.base_part, _triangular_trough_slot)
        updated_model.mergeclose()
        updated_model = mdc.segmentation(updated_model)
    ...
    def rectangular_trough_slot(self):
        ...
        updated_model = mdc.difference(self.base_part, _rectangular_trough_slot)
        updated_model.mergeclose()
        updated_model = mdc.segmentation(updated_model)
    ...
    def rectangular_blind_slot(self):
        ...
        updated_model = mdc.difference(self.base_part, _rectangular_blind_slot)
        updated_model.mergeclose()
        updated_model = mdc.segmentation(updated_model)
    ...
    def triangular_pocket(self):
        ...
        updated_model = mdc.difference(self.base_part, _triangular_pocket)
        updated_model.mergeclose()
        updated_model = mdc.segmentation(updated_model)
    ...
    def rectangular_pocket(self):
        ...
        updated_model = mdc.difference(self.base_part, _rectangular_pocket)
        updated_model.mergeclose()
        updated_model = mdc.segmentation(updated_model)
    ...
    def circular_end_pocket(self):
        ...
        _width = np.random.uniform(1, (8 * self.machining_feature_limit))
        _length = np.random.uniform(1, (9 * self.machining_feature_limit) - _width)
        _depth = 10.4
        ...
        updated_model = mdc.difference(self.base_part, _circular_end_pocket)
        updated_model.mergeclose()
        updated_model = mdc.segmentation(updated_model)
    ...
    def triangular_blind_step(self):
        ...
        X = np.random.uniform(1, (9 * self.machining_feature_limit))
        Y = np.random.uniform(1, (9 * self.machining_feature_limit))
        _depth = np.random.uniform(1, 9)
        ...
        updated_model = mdc.difference(self.base_part, _triangular_blind_step)
        updated_model.mergeclose()
        updated_model = mdc.segmentation(updated_model)
    ...
    def circular_blind_step(self):
        ...
        R = np.random.uniform(1, (9 * self.machining_feature_limit))
        _depth = np.random.uniform(1, 9)

        _circular_blind_step = mdc.cylinder(mdc.vec3(-0.2, -0.2, 10.2), mdc.vec3(-0.2, -0.2, _depth), R)

        updated_model = mdc.difference(self.base_part, _circular_blind_step)
        updated_model.mergeclose()
        updated_model = mdc.segmentation(updated_model)
    ...
    def rectangular_blind_step(self):
        ...
        updated_model = mdc.difference(self.base_part, _rectangular_blind_step)
        updated_model.mergeclose()
        updated_model = mdc.segmentation(updated_model)
    ...
    def two_side_through_step(self):
        ...
        _width_A = np.random.uniform(1, (8 * self.machining_feature_limit))
        _width_B = np.random.uniform(_width_A + 0.5, (9 * self.machining_feature_limit))
        Depth = np.random.uniform(1, 9)
        ...
        updated_model = mdc.difference(self.base_part, _two_side_through_step)
        updated_model.mergeclose()
        updated_model = mdc.segmentation(updated_model)
    ...
    def slanted_through_step(self):
        ...
        _width_A = np.random.uniform(1, (9 * self.machining_feature_limit))
        _width_B = np.random.uniform(1, (9 * self.machining_feature_limit))
        Depth = np.random.uniform(1, 9)
        ...
        updated_model = mdc.difference(self.base_part, _slanted_through_step)
        updated_model.mergeclose()
        updated_model = mdc.segmentation(updated_model)
    ...
    def chamfer(self):
        ...
        X = np.random.uniform(1, (9 * self.machining_feature_limit))
        Z = np.random.uniform(1, (9 * self.machining_feature_limit))
        Depth = 10.4
        ...
        updated_model = mdc.difference(self.base_part, _chamfer)
        updated_model.mergeclose()
        updated_model = mdc.segmentation(updated_model)
    ...
    def round(self):
        ...
        updated_model = mdc.difference(self.base_part, _round)
        updated_model.mergeclose()
        updated_model = mdc.segmentation(updated_model)
    ...
    def vertical_circular_end_blind_slot(self):
        ...
        _length = np.random.uniform(1, (9 * self.machining_feature_limit))
        _width = np.random.uniform(1, (9 * self.machining_feature_limit) - _length)
        _depth = np.random.uniform(1, 9)
        ...
        updated_model = mdc.difference(self.base_part, _v_circular_end_blind_slot)
        updated_model.mergeclose()
        updated_model = mdc.segmentation(updated_model)
    ...
    def horizontal_circular_end_blind_slot(self):
        ...
        _width = np.random.uniform(1, (4 * self.machining_feature_limit))
        _length = np.random.uniform(1, (9 * self.machining_feature_limit) - (2 * _width))
        ...
        updated_model = mdc.difference(self.base_part, _h_circular_end_blind_slot)
        updated_model.mergeclose()
        updated_model = mdc.segmentation(updated_model)
    ...
    def six_side_passage(self):
        ...
        _radius = np.random.uniform(1, (4.5 * self.machining_feature_limit))
        ...
        updated_model = mdc.difference(self.base_part, _six_side_passage)
        updated_model.mergeclose()
        updated_model = mdc.segmentation(updated_model)
    ...
    def six_side_pocket(self):
        ...
        updated_model = mdc.difference(self.base_part, _six_side_pocket)
        updated_model.mergeclose()
        updated_model = mdc.segmentation(updated_model)
